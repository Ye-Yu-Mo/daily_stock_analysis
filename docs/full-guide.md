...
> 兼容说明（Issue #1815）：`MARKET_REVIEW_REGION=cn|hk|us|jp|kr|tw|both` 仅扩展大盘复盘输入集合；JP/KR 仅供复盘上下文消费，不会放开 Market Light 告警（TW 已支持 Market Light 告警，指数级口径，见 [市场支持边界](market-support.md)）。
